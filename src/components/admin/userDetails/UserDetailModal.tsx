...
import type { UserDetailTab, UserDetailTabConfig } from '../../../types/admin/userDetail.types';
...
export const UserDetailModal: React.FC<UserDetailModalProps> = ({
  ...
  const { profile, orders, addresses, wishlist, cart, loading, error, fetchUserData } = useUserDetail();
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      case 'profile':
        return <UserProfileTab profile={profile} loading={loading} formatDate={formatDate} formatCurrency={formatCurrency} />;
      case 'orders':
        return <UserOrdersTab orders={orders} loading={loading} formatDate={formatDate} formatCurrency={formatCurrency} />;
      case 'addresses':
        return <UserAddressesTab addresses={addresses} loading={loading} formatDate={formatDate} />;
      case 'wishlist':
        return <UserWishlistTab wishlist={wishlist} loading={loading} formatDate={formatDate} formatCurrency={formatCurrency} />;
      case 'cart':
        return <UserCartTab cart={cart} loading={loading} formatDate={formatDate} formatCurrency={formatCurrency} />;
      default:
        return null;
    }
  };
