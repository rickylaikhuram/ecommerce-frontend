      ...
      if (!isAuthenticated) {
        return (
          <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-emerald-100">
            ...
            <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent">
              Welcome Back!
            </h2>
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-8 py-4 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Sign In to Continue
              </button>
        ...
        return (
          <div className="bg-white rounded-xl shadow-lg p-8 border border-green-100 space-y-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-8 py-3 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="bg-emerald-600 text-white px-4 py-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => onContinueToAddress()}
                  className="bg-white bg-opacity-20 hover:bg-opacity-30 text-emerald-600 font-medium text-sm px-3 py-1.5 rounded-md border border-white border-opacity-30 hover:border-opacity-50 transition-all duration-200 hover:shadow-sm"
                >
                  CHANGE
                </button>
              </div>
