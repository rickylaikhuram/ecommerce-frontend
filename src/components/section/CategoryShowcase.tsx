              ...
              {categories.map((category) => (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* Image Container */}
                    <div className="relative w-28 h-28 rounded-full overflow-hidden ring-2 ring-gray-200 group-hover:ring-4 group-hover:ring-opacity-60 transition-all duration-300">
                      <img
            ...
            {categories.map((category) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  {/* Image Container */}
                  <div className="relative w-32 h-32 rounded-full overflow-hidden ring-2 ring-gray-200 group-hover:ring-4 group-hover:ring-opacity-60 transition-all duration-300">
                    <img
                      src={category.imageUrl}
                      alt={`${category.name} Jersey`}
                      className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500"
