      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="relative">
            ...
            <LogIn className="relative text-emerald-600 w-10 h-10 sm:w-12 sm:h-12" />
          </div>
        </div>

        <div className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-2xl shadow-emerald-100/50 p-6 sm:p-8 lg:p-10 border border-white/50">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-emerald-600 bg-gray-50 border-gray-300 rounded focus:ring-emerald-500 focus:ring-2"
                />
