...
const bestSellerProducts: ProductWithDetails[] = [
  ...
  },
  {
    ...
    images: [
      {
        id: 'img7',
        imageUrl: 'https://images.unsplash.com/photo-1591290619762-06612ee98f87?w=500&h=500&fit=crop',
...
const featuredProducts = bestSellerProducts.filter(p => parseFloat(p.fakePrice.toString()) > 100); // Products with higher original price
  ...
  return (
    <main className="flex flex-col">
      ...
      <Suspense fallback={<Loading />}>
        <ProductSection
          title="Electronics"
          products={bestSellerProducts.filter(p => p.category?.name === 'Electronics')}
          onToggleWishlist={handleToggleWishlist}
          wishlistedItems={wishlist}
          onProductClick={handleProductClick}
